...
namespace Chip8.Forms
{
    public unsafe class SdlRenderer : IRenderer, IDisposable
    {
        ...
        public SdlRenderer(Sdl sdl, Window* window, Surface* surface)
        {
            simpleSound = new SoundPlayer(@"assets\beep.wav");
            this.sdl = sdl;
            this.window = window;
        ...
        public bool Init()
        {
            ...
            Rectangle<int> pixel = new Rectangle<int>(0, 0, 640, 320);
            sdl.FillRect(surface, ref pixel, off);
